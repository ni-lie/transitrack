...
List<Member> Members = [
  ...
  Member(fullname: "Denver Bugaoisan", description: "I took charge of designing the exhibit's facade while also making contributions to the calibration of the accelerometer and air quality sensor modules. Additionally, I made contributions to various sections of the documentation.", github: "github.com/P5ychopomp", email: "dnvr.bugaoisan@gmail.com", linkedin: "linkedin.com/in/dnverb", img: 'assets/denver.png'),
  Member(fullname: "Zedec Inalvez Pacaldo", description: "I created the mobile responsive website for this project as well as the assets. I also made sure that data from the sensors gets to our cloud database and it is properly received and processed by the website in realtime.", github: "github.com/zedecpacaldo", email: "zedec.pacaldo@gmail.com", linkedin: "linkedin.com/in/zedecpacaldo", img: 'assets/zedec.png'),
  Member(fullname: "Cjay Coronel Jr.", description: "My primary role revolves around the final IoT device. I also hold a co-responsibility for logistics, making sure that all needed resources are required. Lastly, I am responsible for analyzing packets sent from our device to Firestore and vice-versa.", github: "github.com/ni-lie", email: "cjay.coronel25@gmail.com", linkedin: "linkedin.com/in/willie-jr-coronel", img: 'assets/cj.jpg'),
  Member(fullname: "Vann Vedasto", description: "In this project, my main role was to document the project's functions and how it was implemented. I annotated the source codes, defined the services provided by our IoT device, and created presentation slides for our pitch.", github: "github.com/likaelvan", email: "vedastovann@gmail.com", linkedin: "linkedin.com/in/likaelvan", img: 'assets/van.jpg'),
];